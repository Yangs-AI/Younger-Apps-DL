...
# Last Modified time: 2026-01-12 17:08:32
...
class SAGENodeClassification(nn.Module):
    ...
    def forward(self, x, edge_index, x_position = None):
        ...
        if self.stage == 'encode':
            raise NotImplementedError('SAGENodeClassification does not support "encode" stage currently.')
