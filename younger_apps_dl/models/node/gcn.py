...
# Last Modified time: 2026-01-12 17:08:14
...
@register_model("gcn_node_classification")
class GCNNodeClassification(nn.Module):
    ...
    def __init__(self, node_emb_size, node_emb_dim, hidden_dim, dropout_rate, stage: Literal['encode', 'classify', 'embedding'] = 'classify'):
        ...
        self.layer_1 = GCNConv(node_emb_dim, hidden_dim)
        self.layer_2 = GCNConv(hidden_dim, node_emb_size)
    ...
    def forward(self, x, edge_index, x_position = None):
        ...
        if self.stage == 'encode':
            raise NotImplementedError('GCNNodeClassification does not support "encode" stage currently.')
