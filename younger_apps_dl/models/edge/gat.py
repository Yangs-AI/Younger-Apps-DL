...
# Last Modified time: 2026-01-13 14:41:06
...
@register_model('gat_edge_classification')
class GATEdgeClassification(nn.Module):
    def __init__(self, node_emb_size, node_emb_dim, hidden_dim, output_dim, dropout_rate):
        super(GATEdgeClassification, self).__init__()
        self.dropout_rate = dropout_rate
        self.node_embedding_layer = Embedding(node_emb_size, node_emb_dim)
        self.layer_1 = GATConv(node_emb_dim, hidden_dim, heads=8, concat=False)
        self.layer_2 = GATConv(hidden_dim, output_dim, heads=8, concat=False)
