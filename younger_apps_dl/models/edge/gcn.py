...
# Last Modified time: 2026-01-13 14:40:51
...
@register_model('gcn_edge_classification')
class GCNEdgeClassification(nn.Module):
    def __init__(self, node_emb_size, node_emb_dim, hidden_dim, output_dim, dropout_rate):
        ...
        self.layer_2 = GCNConv(hidden_dim, output_dim)
